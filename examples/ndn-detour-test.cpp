...
main(int argc, char* argv[])
{
  ...
  cout<<"Src1 has ID: "<<consumer1->GetId();
  Ptr<Node> consumer2 = Names::Find<Node>("Src2");
  cout<<"Src2 has ID: "<<consumer2->GetId();

  Ptr<Node> producer1 = Names::Find<Node>("Dst1");
  cout<<"Dst1 has ID: "<<producer1->GetId();
  Ptr<Node> producer2 = Names::Find<Node>("Dst2");
  cout<<"Dst2 has ID: "<<producer2->GetId();
  
  Ptr<Node> router1 = Names::Find<Node>("Rtr1");
  cout<<"Rtr1 has ID: "<<router1->GetId();
  Ptr<Node> router2 = Names::Find<Node>("Rtr2");
  cout<<"Rtr2 has ID: "<<router2->GetId();
  Ptr<Node> router3 = Names::Find<Node>("Rtr3");
  cout<<"Rtr3 has ID: "<<router3->GetId();
